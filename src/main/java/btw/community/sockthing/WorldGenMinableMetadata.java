...
public class WorldGenMinableMetadata extends WorldGenMinable {
    ...
    public WorldGenMinableMetadata(int minableBlockId, int metadata, int numberOfBlocks, int field_94523_c) {
        super(minableBlockId, numberOfBlocks, field_94523_c);
        this.minableBlockId = minableBlockId;
        this.numberOfBlocks = numberOfBlocks;
        this.field_94523_c = field_94523_c;
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                {
                                    //SOCK: Changed int iMetadata = 0;
                                    int iMetadata = this.metadata;
